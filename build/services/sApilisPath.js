...
class ApilisPathServicios {
    ...
    static getPath(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const category = yield ApilisPath_1.default.findByPk(id);
            if (!category) {
                //console.log("Error");
            }
            return category;
    ...
    static addPath(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const apilisBrand = yield ApilisPath_1.default.create(data);
    ...
    static updatePath(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            config_database_1.default.transaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                let apilisBrand = yield ApilisPath_1.default.findOne({
                    where: {
                        id
                    }
                });
