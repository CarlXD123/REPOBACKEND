...
const rNation_1 = __importDefault(require("./routes/rNation"));
const rApilisBrand_1 = __importDefault(require("./routes/rApilisBrand"));
const rApilisModel_1 = __importDefault(require("./routes/rApilisModel"));
const rApilisPath_1 = __importDefault(require("./routes/rApilisPath"));
const rAmb_1 = __importDefault(require("./routes/rAmb"));
const rMatchData_1 = __importDefault(require("./routes/rApilisMatchData"));
...
class Server {
    ...
    routes() {
        ...
        this.app.use("/api/nation", rNation_1.default);
        this.app.use("/api/brand", rApilisBrand_1.default);
        this.app.use("/api/model", rApilisModel_1.default);
        this.app.use("/api/path", rApilisPath_1.default);
        this.app.use("/api/amb", rAmb_1.default);
        this.app.use("/api/match", rMatchData_1.default);
    }
    start() {
